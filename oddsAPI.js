...
export const fetchSports = () => {
  ...
  export const fetchUpcomingGames = (sportKey) => {
    return axios
      .get(`https://api.the-odds-api.com/v4/sports/${sportKey}/odds`, {
        params: {
          apiKey,
          regions: 'us', // Replace with the correct value for regions
          markets: 'h2h', // Replace with the correct value for markets
          oddsFormat: 'decimal', // Replace with the correct value for oddsFormat
          dateFormat: 'iso', // Replace with the correct value for dateFormat
        },
      })
      .then((response) => {
        return response.data;
